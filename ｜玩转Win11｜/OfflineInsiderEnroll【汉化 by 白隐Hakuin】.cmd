...
if %build% LSS 17763 (
    ...
    echo 该脚本仅与Windows 10 v1809及更高版本兼容
    echo =============================================================
    echo.
    pause
    goto :EOF
...
:CHOICE_MENU
cls
title OfflineInsiderEnroll 汉化by白隐Hakuin v%scriptver%
set "choice="
echo.
echo 1 - Enroll to Dev Channel  加入Dev频道
echo 2 - Enroll to Beta Channel  加入Beta频道
echo 3 - Enroll to Release Preview Channel  加入RP（Release Preview）频道
echo.
echo 4 - Stop receiving Insider Preview builds  停止接收内部预览版本
echo 5 - Quit without making any changes  不做任何更改而退出
echo.
set /p choice="Choice:   选择："
echo.
...
(
echo Windows Registry Editor Version 5.00  Windows注册表编辑器 版本5.00
echo （译者注：我也不知道这什么意思，反正照着翻的，知道的帮忙发issue到GitHub谢谢！）
echo.
...
:ASK_FOR_REBOOT
set "choice="
echo A reboot is required to finish applying changes.  需要重新启动才能完成应用更改。
set /p choice="Would you like to reboot your PC?  想要重新启动电脑吗？ (y/N) "
